...
public class Main {
    ...
    Person person2 = new Person("Olga", "Sinica", new Addres("Brest", "Moskovskaya", 17));
    Person person3 = new Person("Elena", "Vorobey", new Addres("Grodno", "Pyshkina", 10));
    ...
    Person person6 = new Person("Andrei", "Socolov", null);
